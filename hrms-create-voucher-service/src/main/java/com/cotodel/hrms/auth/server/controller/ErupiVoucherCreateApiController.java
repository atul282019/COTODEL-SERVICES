...
@RestController
@RequestMapping("/Api")
public class ErupiVoucherCreateApiController extends CotoDelBaseController{
	
	private static final Logger logger = LoggerFactory.getLogger(ErupiVoucherCreateApiController.class);

...
public class CommonUtility {
	...
	public static String userRequest(String requestJson,String clientid,String clientSecret,String url){
	...
	public static String getTokenRequest(String requestJson,String clientid,String clientSecret,String url){
		String returnStr=null;
		RestTemplate restTemplate = new RestTemplate();
		HttpHeaders headers = new HttpHeaders();
		try{

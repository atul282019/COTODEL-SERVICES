...
//	    @RequestMapping(value = "/get/rewardsTierList",produces = {"application/json"}, 
//	    consumes = {"application/json","application/text"},method = RequestMethod.POST)
//	    public ResponseEntity<Object> rewardsTierList(HttpServletRequest request,@Valid @RequestBody EncriptResponse enResponse) {
//		 
//	    logger.info("inside rewardsTierList....");    	
//	    
//	    	String message = "";
//	    	List<RewardsTierEntity> response=null;
...
//				RewardsTierRequest rewardsTierRequest= EncryptionDecriptionUtil.convertFromJson(decript, RewardsTierRequest.class);
//				
//				response=rewardsTierService.getRewardsTierList(rewardsTierRequest);
//	    		
//				if(response!=null && response.size()>0) {
//					erupiVoucherSmsResponse=new ErupiVoucherSmsResponse(MessageConstant.TRUE,MessageConstant.RESPONSE_SUCCESS,response,TransactionManager.getTransactionId(),TransactionManager.getCurrentTimeStamp());
...
//	    		}
//	    	}catch (Exception e) {				
//	    		logger.error("error in rewardsTierList====="+e);
//			}

...
@Slf4j
@Repository
public class ErupiVoucherCreationDetailsServiceImpl implements ErupiVoucherCreationDetailsService{


	private static final Logger logger = LoggerFactory.getLogger(ErupiVoucherCreationDetailsServiceImpl.class);
	@Autowired
...
//		}
		...
		public ErupiVoucherCreateDetailsRequest saveErupiVoucherCreationDetails(ErupiVoucherCreateDetailsRequest request) {
			String response="";
			log.info("Starting ErupiVoucherCreationDetailsServiceImpl ... saveErupiVoucherCreationDetails..");
			ErupiVoucherCreationDetailsEntity erupiVoucherInitiateDetailsEntity=null;
			ErupiVoucherTxnDetailsEntity erupiVoucherTxnDetailsEntity=null;
			JSONObject profileJsonRes=null;
...
//				}else 
				...
				e.printStackTrace();
				request.setResponseApi("exception:Bad request some field are missing");
				log.error("Error in ErupiVoucherCreationDetailsServiceImpl......."+e.getMessage());
			}
			return request;
		}

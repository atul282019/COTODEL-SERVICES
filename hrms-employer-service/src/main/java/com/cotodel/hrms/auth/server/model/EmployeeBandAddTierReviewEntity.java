...
@AllArgsConstructor
@NoArgsConstructor
@Table(name="employee_band_add_tier_review")
@Access(value=AccessType.FIELD)
@SequenceGenerator(name="employee_band_add_tier_review_seq" , sequenceName="employee_band_add_tier_review_seq", allocationSize=1)

public class EmployeeBandAddTierReviewEntity implements Serializable{
	
	private static final long serialVersionUID = 4615208660281419839L;
	
	@Id
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="employee_band_add_tier_review_seq")	
	@Column(name="id")
	private Long id;	

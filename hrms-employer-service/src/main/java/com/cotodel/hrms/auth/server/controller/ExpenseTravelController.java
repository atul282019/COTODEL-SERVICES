...
//	    }
	 @Operation(summary = "This API will provide the Save User Details ", security = {
	    ...
	    @ApiResponse(responseCode = "404",description = "Request Resource was not found", content = @Content(mediaType = "application/json",schema = @Schema(implementation = ApiError.class))),
	    @ApiResponse(responseCode = "500",description = "System down/Unhandled Exceptions", content = @Content(mediaType = "application/json",schema = @Schema(implementation = ApiError.class)))})
	    @RequestMapping(value = "/get/advanceTravelSequenceIdRequestStatus",produces = {"application/json"}, 
	    consumes = {"application/json","application/text"},method = RequestMethod.POST)
	    public ResponseEntity<Object> advanceTravelSequenceIdRequestStatus(HttpServletRequest request,@Valid @RequestBody EncriptResponse enResponse) {
	    ...
	    logger.info("inside get/advanceTravelRequestStatus+++");	    	
	    	...
	    	try {	    		
				...
				response=expenseTravelAdvanceService.getAdvenceTravelBySequenceIdListByStatus(advanceTravelRequest.getEmployerId(),advanceTravelRequest.getEmployeeId(),advanceTravelRequest.getStatus(),advanceTravelRequest.getSequeneId());
	    		if(response!=null) {
	    			advanceTravelAllResponse=new AdvanceTravelAllResponse(MessageConstant.TRUE,MessageConstant.PROFILE_SUCCESS,response,TransactionManager.getTransactionId(),TransactionManager.getCurrentTimeStamp());
	    			String jsonEncript =  EncryptionDecriptionUtil.convertToJson(advanceTravelAllResponse);
	    			EncriptResponse jsonEncriptObject=EncryptionDecriptionUtil.encriptResponse(jsonEncript, applicationConstantConfig.apiSignaturePublicPath);
	 ...
	 @Operation(summary = "This API will provide the Save User Details ", security = {
	    ...
	    @ApiResponse(responseCode = "404",description = "Request Resource was not found", content = @Content(mediaType = "application/json",schema = @Schema(implementation = ApiError.class))),
	    @ApiResponse(responseCode = "500",description = "System down/Unhandled Exceptions", content = @Content(mediaType = "application/json",schema = @Schema(implementation = ApiError.class)))})
	    @RequestMapping(value = "/get/advanceTravelRequestDraftStatus",produces = {"application/json"}, 
	    consumes = {"application/json","application/text"},method = RequestMethod.POST)
	    public ResponseEntity<Object> advanceTravelRequestDraftStatus(HttpServletRequest request,@Valid @RequestBody EncriptResponse enResponse) {
	    ...
	    logger.info("inside get/advanceTravelRequestStatus+++");	    	
	    	...
	    	try {	    		
				...
				response=expenseTravelAdvanceService.getAdvenceTravelListByDraftStatus(advanceTravelRequest.getEmployerId(),advanceTravelRequest.getEmployeeId(),advanceTravelRequest.getStatus());
	    		if(response!=null) {
	    			advanceTravelAllResponse=new AdvanceTravelAllResponse(MessageConstant.TRUE,MessageConstant.PROFILE_SUCCESS,response,TransactionManager.getTransactionId(),TransactionManager.getCurrentTimeStamp());
	    			String jsonEncript =  EncryptionDecriptionUtil.convertToJson(advanceTravelAllResponse);
	    			EncriptResponse jsonEncriptObject=EncryptionDecriptionUtil.encriptResponse(jsonEncript, applicationConstantConfig.apiSignaturePublicPath);

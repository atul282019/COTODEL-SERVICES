...
@AllArgsConstructor
@NoArgsConstructor
@Table(name="payroll_master_new")
@Access(value=AccessType.FIELD)
@SequenceGenerator(name="payroll_master_new_seq" , sequenceName="payroll_master_new_seq", allocationSize=1)
public class PayrollMasterNewEntity implements Serializable{
	
	private static final long serialVersionUID = 4615208660281419839L;
	@Id
	@GeneratedValue(strategy=GenerationType.AUTO, generator="payroll_master_new_seq")
	@Column(name="id")
	private Long id;
